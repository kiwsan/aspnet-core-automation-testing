...
namespace ToDo.UnitTests.Services
{
    ...
    public class ItemToDoSqliteInMemoryService_Tests : DbOptionBase
    {
        ...
        private readonly ItemTodo _firstItem = new ItemTodo() { Id = Guid.Parse("965468a8-9c0e-4ebd-9538-4987eb0c995d"), Name = "First Item" };
        private readonly ItemTodo _secondItem = new ItemTodo() { Id = Guid.Parse("217303d1-26ae-4a1a-aaca-7b920a7cbaaa"), Name = "Second Item" };
        private ItemTodo[] _items;

        private AppDbContext _dbContext;
        private IItemToDoSqliteInMemoryService _itemToDoService;
        ...
        public void Init()
        {
            ...
            _itemToDoService = new ItemToDoSqliteInMemoryService(_dbContext);
